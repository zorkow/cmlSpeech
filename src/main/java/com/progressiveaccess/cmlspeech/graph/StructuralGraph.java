...
public class StructuralGraph extends SimpleGraph<String, StructuralEdge> {
  ...
  /**
   * Adds a number of edges for a source structure within a given context.
   * Connections are only added if the goal of the connection also lives in that
   * context, e.g., is part of the same atom set.
   *
   * @param source
   *          Name of the source structure.
   * @param connections
   *          Set of connections for the source structures.
   * @param systems
   *          The system providing the context.
   */
