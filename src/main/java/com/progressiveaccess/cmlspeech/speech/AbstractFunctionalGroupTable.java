...
/**
 * @file AbstractFunctionalGroupTable.java
 * @author Volker Sorge <a href="mailto:V.Sorge@progressiveaccess.com">Volker
 *         Sorge</a>
 * @date Fri Jun 20 02:00:25 2014
 *
 * @brief Abstract class for the localised functional group tables.
 *
 *
 */
...
/**
 * Localised functional group tables.
 */
public class AbstractFunctionalGroupTable extends HashMap<String, String>
    implements FunctionalGroupTable {
