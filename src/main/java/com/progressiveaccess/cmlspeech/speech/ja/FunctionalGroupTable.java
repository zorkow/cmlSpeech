...
public final class FunctionalGroupTable extends AbstractFunctionalGroupTable {
  ...
  public FunctionalGroupTable() {
    ...
    this.put("Azo Nitrogen. Diazene", "アゾ窒素。ジアゼン");
    ...
    this.put("Dicarboxdiimide", "ディカルボジイミド");
    ...
    this.put("Three halides groups", "3ハロゲン化物グループ");
    this.put("Acyl Halide", "ハロゲン化アシル");
    this.put("Alkene", "アルケン");
    this.put("Alkyne", "アルキン");
    this.put("Allene", "アレン");
    this.put("Alkylchloride", "塩化アルキル");
    this.put("Alkylfluoride", "フッ化アルキル");
    this.put("Alkylbromide", "臭化アルキル");
    this.put("Alkyliodide", "ヨウ化アルキル");
    ...
    this.put("Dialkylthioether", "ディアルキルチオエーテル");
    this.put("Alkylarylether", "アルキルアリール");
    this.put("Diarylether", "ジアリール");
    this.put("Alkylarylthioether", "アルキルチオエーテル");
    this.put("Diarylthioether", "ジアリールチオエーテル");
    ...
    this.put("Dialkylthioether", "ジアルキルチオエーテル");
    this.put("Alkylarylthioether", "アルキルチオエーテル");
    ...
    this.put("Thiohemiacetal", "チオヘミアセタール");
    ...
    this.put("Hetero methylen ester and similar",
             "ヘテロメチレンエステルと同様の");
    this.put("Cyanhydrine", "シアンヒドリンゴム");
    this.put("Chloroalkene", "クロロアルケン");
    this.put("Fluoroalkene", "フルオロアルケン");
    this.put("Bromoalkene", "ブロモアルケン");
    this.put("Iodoalkene", "ヨードアルケン");
    this.put("Enol", "エノール");
    this.put("Endiol", "エンジオール");
    this.put("Enolether", "エノールエーテル");
    this.put("Enolester", "エノールエステル");
    this.put("Enamine", "エナミン");
    this.put("Thioenol", "チオエノール");
    this.put("Thioenolether", "チオエノールエーテル");
    this.put("Acylchloride", "塩化アシル");
    this.put("Acylfluoride", "フッ化アシル");
    this.put("Acylbromide", "酸臭化物");
    this.put("Acyliodide", "アシル、ヨウ化");
    ...
    this.put("Carbodithioic acid", "カルボジチオ酸");
    this.put("Carbodithioic ester", "カルボジチオエステル");
    this.put("Carbodithiolactone", "カルボジチオラクトン");
    this.put("Amide", "アミド");
    ...
    this.put("Oximester", "オキシムエステル");
    this.put("Amidine", "アミジン");
    this.put("Hydroxamic acid", "ヒドロキサム酸");
    this.put("Hydroxamic acid ester", "ヒドロキサム酸エステル");
    this.put("Imidoacid", "イミド酸");
    this.put("Imidoacid cyclic", "イミド酸の環状");
    this.put("Imidoester", "イミドエステル");
    this.put("Imidolactone", "イミドラクトン");
    this.put("Imidothioacid", "イミドチオ酸");
    this.put("Imidothioacid cyclic", "イミド、環状アミノチオ");
    this.put("Imidothioester", "イミドチオエステル");
    this.put("Imidothiolactone", "イミドチオラクトン");
    this.put("Amidine", "アミジン");
    this.put("Imidolactam", "イミドラクタム");
    this.put("Imidoylhalide", "イミドイルハロゲン化物");
    this.put("Imidoylhalide cyclic", "イミドイルハロゲン化環状");
    ...
    this.put("Carbonic acid dieester", "炭酸ダイエステル");
    this.put("Carbonic acid esterhalide", "炭酸エステルハライド");
    this.put("Carbonic acid monoester", "炭酸モノエステル");
    this.put("Carbonic acid derivatives", "炭酸誘導体");
    this.put("Thiocarbonic acid dieester", "チオ炭酸ダイエステル");
    this.put("Thiocarbonic acid esterhalide", "チオ酸エステルハライド");
    ...
    this.put("Orthocarbonic derivatives", "オルト炭酸デリバティブ");
    this.put("Phenol", "フェノール");
    this.put("1,2-Diphenol", "1,2-ジフェノール");
    this.put("Arylchloride", "塩化アリール");
    this.put("Arylfluoride", "フッ化アリール");
    this.put("Arylbromide", "臭化アリール");
    this.put("Aryliodide", "ヨウ化アリール");
    this.put("Arylthiol", "アリールチオール");
    this.put("Iminoarene", "イミノアレーン");
    this.put("Oxoarene", "オキソアレーン");
    this.put("Thioarene", "チオアレーン");
    ...
    this.put("Phosphorylen", "ホスホリル - エン");
    ...
    this.put("Phosphoric monoestermonoamide", "リン酸モノエステルモノアミド");
    this.put("Phosphoric diestermonoamide", "リン酸ジエステルモノアミド");
    this.put("Phosphoric monoesterdiamide", "リン酸モノエステルジアミド");
    ...
    this.put("Silylmonohalide", "シリルモノハライド");
    this.put("Het trialkylsilane", "ヘットトリアルキルシラン");
    this.put("Dihet dialkylsilane", "ディヘタのジアルキル");
    this.put("Trihet alkylsilane", "トライのヘタアルキルシラン");
