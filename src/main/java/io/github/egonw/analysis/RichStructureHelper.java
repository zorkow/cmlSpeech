...
public final class RichStructureHelper {
    ...
    public static RichStructure<?> setRichAtom(IAtom atom) {
        return RichStructureHelper.setRichStructure
            (RichStructureHelper.richAtoms, atom.getID(), new RichAtom(atom));
    }
    ...
    public static RichStructure<?> setRichBond(IBond bond) {
        return RichStructureHelper.setRichStructure
            (RichStructureHelper.richBonds, bond.getID(), new RichBond(bond));
    }
    ...
    public static RichStructure<?> setRichStructure
        (SortedMap<String, RichStructure<?>> map, String id, RichStructure<?> structure) {
    ...
    public static List<RichAtom> getAtoms() {
        return (List<RichAtom>)(List<?>)
            new ArrayList<RichStructure<?>>(RichStructureHelper.richAtoms.values());
    }

    @SuppressWarnings("unchecked")
    public static List<RichBond> getBonds() {
        return (List<RichBond>)(List<?>)
            new ArrayList<RichStructure<?>>(RichStructureHelper.richBonds.values());
    }

    @SuppressWarnings("unchecked")
    public static List<RichAtomSet> getAtomSets() {
        return (List<RichAtomSet>)(List<?>)
            new ArrayList<RichStructure<?>>(RichStructureHelper.richAtomSets.values());
    }
